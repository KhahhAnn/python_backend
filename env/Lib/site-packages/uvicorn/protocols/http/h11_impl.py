...
class H11Protocol(asyncio.Protocol):
    ...
    def _unsupported_upgrade_warning(self) -> None:
        msg = "Unsupported upgrade response."
    ...
    def handle_events(self) -> None:
        while True:
            try:
                ...
                msg = "Invalid HTTP response received."
                self.logger.warning(msg)
            ...
            if event is h11.NEED_DATA:
                ...
                # of the active response/response cycle we handle any
                ...
                # When starting to process a response, disable the keep-alive
                # timeout. Normally we disable this when receiving data from
                # client and set back when finishing processing its response.
                # However, for pipelined requests processing finishes after
                # already receiving the next response and thus the timer may
