...
class TypeAdapter(Generic[T]):
    ...
    **Note:** By default, `TypeAdapter` does not respect the
    ...
    explicitly set [`experimental_defer_build_mode=('models', 'type_adapter')`][pydantic.config.ConfigDict.experimental_defer_build_mode] of the
    config to defer the models validator and serializer construction. Thus, this feature is opt-in to ensure backwards
    compatibility.
        ...
        *,
        ...
        if not self._defer_build():
            ...
            with self._with_frame_depth(1):  # +1 frame depth for this __init__
                # Model itself may be using deferred building. For backward compatibility we don't rebuild models mocks
    ...
    def validate_python(
        ...
        *,
        ...
        """Validate a Python object against the models.

        Args:
            object: The Python object to validate against the models.
    ...
    def validate_json(
        ...
        Validate a JSON string or bytes against the models.

        Args:
            data: The JSON data to validate against the models.
            strict: Whether to strictly check types.
    ...
    def validate_strings(self, obj: Any, /, *, strict: bool | None = None, context: dict[str, Any] | None = None) -> T:
        """Validate object contains string data against the models.
