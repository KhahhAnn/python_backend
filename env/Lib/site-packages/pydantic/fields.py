...
class FieldInfo(_repr.Representation):
    ...
    Attributes:
        ...
        exclude: Whether to exclude the field from the models serialization.
        ...
        repr: Whether to include the field in representation of the models.
    ...
    def get_default(self, *, call_default_factory: bool = False) -> Any:
        ...
        be called (namely, when instantiating a models via `model_construct`).
...
def PrivateAttr(
    ...
    *,
    ...
    Private attributes are stored in `__private_attributes__` on the models.
...
def computed_field(
    ...
    *,
    ...
    Args:
        ...
        json_schema_extra: A dict or callable to provide extra JSON schema properties.
        repr: whether to include this computed field in models repr.
