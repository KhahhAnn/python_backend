...
DEFAULT_REF_TEMPLATE = '#/$defs/{models}'
...
#       * these might look like the fully qualified path of a models, its id, or something similar
...
class GenerateJsonSchema:
    ...
    def lax_or_strict_schema(self, schema: core_schema.LaxOrStrictSchema) -> JsonSchemaValue:
        ...
        Returns:
            The generated JSON schema.
        """
        # TODO: Need to read the default value off of models config or whatever
    ...
    def model_field_schema(self, schema: core_schema.ModelField) -> JsonSchemaValue:
        """Generates a JSON schema that matches a schema that defines a models field.
    ...
    def model_schema(self, schema: core_schema.ModelSchema) -> JsonSchemaValue:
        """Generates a JSON schema that matches a schema that defines a models.
        ...
        Returns:
            The generated JSON schema.
        """
        # We do not use schema['models'].model_json_schema() here
    ...
    def model_fields_schema(self, schema: core_schema.ModelFieldsSchema) -> JsonSchemaValue:
        """Generates a JSON schema that matches a schema that defines a models's fields.
...
def model_json_schema(
    ...
    """Utility function to generate a JSON Schema for a models.

    Args:
        cls: The models class to generate a JSON Schema for.
...
def models_json_schema(
    ...
    *,
    ...
    Args:
        models: A sequence of tuples of the form (models, mode).
...
class WithJsonSchema:
    ...
    Note that any _modifications_ to the schema that would normally be made (such as setting the title for models fields)
