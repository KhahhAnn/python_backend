...
if TYPE_CHECKING:
    ...
    class ImportString:
        ...
        On models instantiation, pointers will be evaluated and imported. There is
...
if TYPE_CHECKING:
    ...
    class Json:
        ...
        When you dump the models using `model_dump` or `model_dump_json`, the dumped value will be the result of validation,
...
class EncodedBytes:
    ...
    # Initialize the models with encoded data
...
# Initialize the models with base64 data
