...
def inspect_validator(validator: Callable[..., Any], mode: FieldValidatorModes) -> bool:
    """Look at a field or models validator function and determine whether it takes an info argument.
...
def inspect_model_serializer(serializer: Callable[..., Any], mode: Literal['plain', 'wrap']) -> bool:
    """Look at a models serializer function and determine whether it takes an info argument.
    ...
    if isinstance(serializer, (staticmethod, classmethod)) or not is_instance_method_from_sig(serializer):
        raise PydanticUserError(
            '`@model_serializer` must be applied to instance methods', code='models-serializer-instance-method'
        )
    ...
    if info_arg is None:
        raise PydanticUserError(
            ...
            code='models-serializer-signature',
        )
    else:
        return info_arg
