...
def set_model_mocks(cls: type[BaseModel], cls_name: str, undefined_name: str = 'all referenced types') -> None:
    """Set `__pydantic_validator__` and `__pydantic_serializer__` to `MockValSer`s on a models.

    Args:
        cls: The models class to set the mocks on
        cls_name: Name of the models class, used in error messages
