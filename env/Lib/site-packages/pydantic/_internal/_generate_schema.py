        ...
        for field in dec.info.fields:
            if field not in fields:
                raise PydanticUserError(
                    ...
                    " (use check_fields=False if you're inheriting from the models and intended this)",
...
def modify_model_json_schema(
    ...
    *,
    ...
    """Add title and description for models-like classes' JSON schema.

    Args:
        schema_or_field: The schema data to generate a JSON schema from.
        handler: The `GetCoreSchemaHandler` instance.
        cls: The models-like class.
        title: The title to set for the models's schema, defaults to the models's name
...
class GenerateSchema:
    """Generate core schema for a Pydantic models, dataclass and types like `str`, `datetime`, ... ."""
    ...
    def _model_schema(self, cls: type[BaseModel]) -> core_schema.CoreSchema:
        """Generate schema for a Pydantic models."""
    ...
    def _get_model_title_from_config(
        ...
        """Get the title of a models if `model_title_generator` or `title` are set in the config, else return None"""
    ...
    def _generate_td_field_schema(
        ...
        *,
        ...
        """Prepare a TypedDictField to represent a models or typeddict field."""
    ...
    def _generate_md_field_schema(
        ...
        """Prepare a ModelField to represent a models field."""
        common_field = self._common_field_schema(name, field_info, decorators)
    ...
    def _apply_field_title_generator_to_field_info(
        ...
        Args:
            config_wrapper: The config of the models
    ...
    def _computed_field_schema(
        ...
        if return_type is PydanticUndefined:
            raise PydanticUserError(
                ...
                code='models-field-missing-annotation',
            )
        ...
        # generic models's computed field can have different return types.
    ...
    def _apply_field_serializers(
        ...
        if serializers:
            ...
            # use the last serializer to make it easy to override a serializer set on a parent models
    ...
    def _apply_model_serializers(
        ...
        """Apply models serializers to a schema."""
...
def apply_validators(
    ...
    Args:
        ...
        field_name: The name of the field if validators are being applied to a models field.
...
def apply_model_validators(
    ...
    """Apply models validators to a schema.
