...
def collect_model_fields(  # noqa: C901
    ...
    *,
    ...
    """Collect the fields of a nascent pydantic models.
    ...
    Raises:
        NameError:
            ...
            - If a field shadows an attribute in the parent models.
    """
    ...
    for ann_name, ann_type in type_hints.items():
        ...
        # when building a generic models with `MyModel[int]`, the generic_origin check makes sure we don't get
