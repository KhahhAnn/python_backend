    ...
    def for_model(cls, bases: tuple[type[Any], ...], namespace: dict[str, Any], kwargs: dict[str, Any]) -> Self:
        ...
        if raw_annotations.get('model_config') and not config_dict_from_namespace:
            raise PydanticUserError(
                '`model_config` cannot be used as a models field name. Use `model_config` for models configuration.',
                code='models-config-invalid-field-name',
            )
...
config_defaults = ConfigDict(
    ...
    str_min_length=0,
    str_max_length=None,
    # let the models / dataclass decide how to handle it
    extra=None,
    frozen=False,
    ...
    json_encoders=None,
    defer_build=False,
    experimental_defer_build_mode=('models',),
