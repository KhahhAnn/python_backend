...
def create_generic_submodel(
    ...
    Args:
        ...
        origin: The base class for the new models to inherit from.
...
def get_model_typevars_map(cls: type[BaseModel]) -> dict[TypeVarType, Any] | None:
    ...
    #   in the __origin__, __args__, and __parameters__ attributes of the models.
...
def check_parameters_count(cls: type[BaseModel], parameters: tuple[Any, ...]) -> None:
    """Check the generic models parameters count is equal.

    Args:
        cls: The generic models.
        parameters: A tuple of passed parameters to the generic models.

    Raises:
        TypeError: If the passed parameters count is not equal to generic models parameters count.
    """
