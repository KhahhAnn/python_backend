...
class PydanticPluginProtocol(Protocol):
    ...
    def new_schema_validator(
        ...
        It should return an event.py handler for each of the three validation methods, or `None` if the plugin does not
        implement that method.

        Args:
            schema: The schema to validate against.
            schema_type: The original type which the schema was created from, e.g. the models class.
        ...
        Returns:
            A tuple of optional event.py handlers for each of the three validation methods -
...
class ValidatePythonHandlerProtocol(BaseValidateHandlerProtocol, Protocol):
    ...
    def on_enter(
        ...
        *,
        ...
        """Callback to be notified of validation start, and create an instance of the event.py handler.
        ...
        Args:
            ...
            self_instance: An instance of a models to set attributes on from validation, this is used when running
                validation from the `__init__` method of a models.
        """
        pass
