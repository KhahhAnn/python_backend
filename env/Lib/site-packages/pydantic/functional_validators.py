...
class ModelWrapValidatorWithoutInfo(Protocol[_ModelType]):
    ...
    def __call__(  # noqa: D102
        self,
        cls: type[_ModelType],
        # this can be a dict, a models instance
...
def model_validator(
    *,
    ...
    Decorate models methods for validation purposes.
    ...
    For more in depth examples, see [Model Validators](../concepts/validators.md#models-validators).
    ...
    Returns:
        A decorator that can be used to decorate a function to be used as a models validator.
    """
