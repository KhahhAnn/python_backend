...
class WrapSerializer:
    ...
    event.py = EventModel(event_datetime=dt)
    print(event.py.model_dump())
    '''
    {
        'event_datetime': {
    ...
    print(event.py.model_dump_json())
    '''
...
def field_serializer(
    *fields: str,
    ...
    Args:
        ...
        check_fields: Whether to check that the fields actually exist on the models.
...
def model_serializer(
    ...
    *,
    ...
    """Decorator that enables custom models serialization.

    This is useful when a models need to be serialized in a customized manner, allowing for flexibility beyond just specific fields.
...
if TYPE_CHECKING:
    ...
    In particular, this means that when models subclasses are serialized, fields present in the subclass
