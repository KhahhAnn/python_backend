...
class RootModel(BaseModel, typing.Generic[RootModelRootType], metaclass=_RootModelMetaclass):
    ...
    A Pydantic `BaseModel` for the root object of the models.

    Attributes:
        root: The root object of the models.
        __pydantic_root_model__: Whether the models is a RootModel.
        __pydantic_private__: Private fields in the models.
        __pydantic_extra__: Extra fields in the models.
    ...
    def __init_subclass__(cls, **kwargs):
        ...
        if extra is not None:
            raise PydanticUserError(
                "`RootModel` does not support setting `model_config['extra']`", code='root-models-extra'
            )
    ...
    def model_construct(cls, root: RootModelRootType, _fields_set: set[str] | None = None) -> Self:  # type: ignore
        """Create a new models using the provided root object and update fields set.
        ...
        Raises:
            NotImplemented: If the models is not a subclass of `RootModel`.
        """
