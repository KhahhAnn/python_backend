...
class Request(Event):
    ...
    .. attribute:: target
       ...
       The target of an HTTP response, e.g. ``b"/index.html"``, or one of the
    ...
    def __init__(
        ...
        *,
        ...
        # HTTP/1.1 response message that lacks a Host header field and to any
        # response message that contains more than one Host header field or a
...
class Data(Event):
    ...
    .. attribute:: chunk_start
       ...
       event.py is provided to :meth:`Connection.send`: it is only valid on
    ...
    .. attribute:: chunk_end
       ...
       a Data event.py is provided to :meth:`Connection.send`: it is only valid
...
class ConnectionClosed(Event):
    """This event.py indicates that the sender has closed their outgoing
    connection.
