...
#
# Strategy: each writer takes an event.py + a write-some-bytes function, which is
# calls.
#
...
def write_headers(headers: Headers, write: Writer) -> None:
    ...
    # response, a user agent SHOULD generate Host as the first header field
    # following the response-line." - RFC 7230
