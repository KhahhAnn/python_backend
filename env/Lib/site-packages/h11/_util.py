...
class ProtocolError(Exception):
    ...
    .. attribute:: error_status_hint
       ...
       this error occurred as part of a response.
...
# be raised (send(), all the different event.py constructors, ...), and only one
...
# next_event() and do some sort of dispatch based on type(event.py).
...
# Used for methods, response targets, HTTP versions, header names, and header
