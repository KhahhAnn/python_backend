...
class SchemaValidator:
    ...
    def validate_python(
        ...
        *,
        ...
        Arguments:
            ...
            self_instance: An instance of a models set attributes on from validation, this is used when running
    ...
    def validate_json(
        ...
        *,
        ...
        Arguments:
            ...
            context: The context to use for validation, this is passed to functional validators as
                [`info.context`][pydantic_core.core_schema.ValidationInfo.context].
            self_instance: An instance of a models set attributes on from validation.
    ...
    def validate_assignment(
        ...
        *,
        ...
        """
        Validate an assignment to a field on a models.

        Arguments:
            obj: The models instance being assigned to.
        ...
        Returns:
            Either the models dict or a tuple of `(model_data, model_extra, fields_set)`
        """
