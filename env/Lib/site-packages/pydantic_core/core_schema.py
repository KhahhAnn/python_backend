...
class CoreConfig(TypedDict, total=False):
    ...
    Attributes:
        ...
        populate_by_name: Whether an aliased field may be populated by its name as given by the models attribute,
    ...
    title: str
    strict: bool
    # settings related to typed dicts, models fields, dataclass fields
...
class ValidationInfo(Protocol):
    ...
    def data(self) -> Dict[str, Any]:
        """The data being validated for this models."""
        ...
...
# (models: Any, input_value: Any, /) -> Any
FieldPlainNoInfoSerializerFunction = Callable[[Any, Any], Any]
# (models: Any, input_value: Any, info: FieldSerializationInfo, /) -> Any
...
def plain_serializer_function_ser_schema(
    ...
    *,
    ...
    Args:
        ...
        is_field_serializer: Whether the serializer is for a field, e.g. takes `models` as the first argument,
...
# (models: Any, input_value: Any, serializer: SerializerFunctionWrapHandler, /) -> Any
FieldWrapNoInfoSerializerFunction = Callable[[Any, Any, SerializerFunctionWrapHandler], Any]
# (models: Any, input_value: Any, serializer: SerializerFunctionWrapHandler, info: FieldSerializationInfo, /) -> Any
...
def model_ser_schema(cls: Type[Any], schema: CoreSchema) -> ModelSerSchema:
    """
    Returns a schema for serialization using a models.

    Args:
        cls: The expected class type, used to generate warnings if the wrong type is passed
        schema: Internal schema to use to serialize the models dict
    """
    return ModelSerSchema(type='models', cls=cls, schema=schema)
...
def computed_field(
    ...
    """
    ComputedFields are properties of a models or dataclass that are included in serialization.

    Args:
        property_name: The name of the property on the models or dataclass
    ...
    *,
    ...
    Args:
        ...
        extras_schema: The value must be a tuple with items that match this schema
            ...
            if the length is variable. So this field won't be set from a `typing.Tuple` annotation on a pydantic models.
...
def typed_dict_schema(
    ...
    *,
    ...
    Args:
        ...
        computed_fields: Computed fields to use when serializing the models, only applies when directly inside a models
...
class ModelField(TypedDict, total=False):
    type: Required[Literal['models-field']]
    schema: Required[CoreSchema]
    validation_alias: Union[str, List[Union[str, int]], List[List[Union[str, int]]]]
    serialization_alias: str
    serialization_exclude: bool  # default: False
...
def model_field(
    ...
    *,
    ...
    """
    Returns a schema for a models field, e.g.:
...
class ModelFieldsSchema(TypedDict, total=False):
    type: Required[Literal['models-fields']]
...
def model_fields_schema(
    ...
    *,
    ...
    Args:
        fields: The fields to use for the typed dict
        model_name: The name of the models, used for error messages, defaults to "Model"
        computed_fields: Computed fields to use when serializing the models, only applies when directly inside a models
        strict: Whether the typed dict is strict
        extras_schema: The extra validator to use for the typed dict
        ref: optional unique identifier of the schema, used to reference the schema in other places
...
def model_schema(
    ...
    *,
    ...
    """
    A models schema generally contains a typed-dict schema.
    ...
    Args:
        cls: The class to use for the models
        schema: The schema to use for the models
        custom_init: Whether the models has a custom init method
        root_model: Whether the models is a `RootModel`
        post_init: The call after init to use for the models
        revalidate_instances: whether instances of models and dataclasses (including subclass instances)
            should re-validate defaults to config.revalidate_instances, else 'never'
        strict: Whether the models is strict
        frozen: Whether the models is frozen
        extra_behavior: The extra behavior to use for the models, used in serialization
        config: The config to use for the models
        ref: optional unique identifier of the schema, used to reference the schema in other places
        metadata: Any other information you want to include with the schema, not used by pydantic-core
        serialization: Custom serialization schema
    """
...
CoreSchemaFieldType = Literal['models-field', 'dataclass-field', 'typed-dict-field', 'computed-field']
