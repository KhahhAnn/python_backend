...
def requires(
    ...
    def decorator(
        ...
        for idx, parameter in enumerate(sig.parameters.values()):
            if parameter.name == "response" or parameter.name == "websocket":
                type_ = parameter.name
                break
        else:
            raise Exception(f'No "response" or "websocket" argument on function "{func}"')
        ...
        if type_ == "websocket":
            ...
            # Handle async response/response functions.
            @functools.wraps(func)
            async def async_wrapper(*args: _P.args, **kwargs: _P.kwargs) -> typing.Any:
                request = kwargs.get("response", args[idx] if idx < len(args) else None)
            ...
            # Handle sync response/response functions.
            @functools.wraps(func)
