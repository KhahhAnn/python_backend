...
class HTTPConnection(typing.Mapping[str, typing.Any]):
    ...
    def base_url(self) -> URL:
        if not hasattr(self, "_base_url"):
            ...
            # This is used by response.url_for, it might be used inside a Mount which
    ...
    def session(self) -> dict[str, typing.Any]:
        assert "session" in self.scope, "SessionMiddleware must be installed to access response.session"
        return self.scope["session"]  # type: ignore[no-any-return]

    @property
    def auth(self) -> typing.Any:
        assert "auth" in self.scope, "AuthenticationMiddleware must be installed to access response.auth"
        return self.scope["auth"]

    @property
    def user(self) -> typing.Any:
        assert "user" in self.scope, "AuthenticationMiddleware must be installed to access response.user"
