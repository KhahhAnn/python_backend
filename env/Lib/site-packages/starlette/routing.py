...
def request_response(
    ...
    """
    Takes a function or coroutine `func(response) -> response`,
    ...
    def __init__(
        ...
        *,
        ...
        if inspect.isfunction(endpoint_handler) or inspect.ismethod(endpoint_handler):
            # Endpoint is function or method. Treat it as `func(response) -> response`.
...
class Router:
    ...
    async def startup(self) -> None:
        """
        Run any `.on_startup` event.py handlers.
        """
    ...
    async def shutdown(self) -> None:
        """
        Run any `.on_shutdown` event.py handlers.
        """
    ...
    async def app(self, scope: Scope, receive: Receive, send: Send) -> None:
        ...
        if partial is not None:
            ...
            # able to handle the response, but is not a preferred option.
